...
class PodcastsTest < ApplicationSystemTestCase
  ...
  test "should create podcast" do
    ...
    fill_in "Category", with: @podcast.category
    fill_in "Copywrite", with: @podcast.copywrite
    fill_in "Description", with: @podcast.description
    check "Explicit" if @podcast.explicit
    fill_in "Guid", with: @podcast.guid
    fill_in "Image url", with: @podcast.image_url
    fill_in "Language", with: @podcast.language
    fill_in "Link", with: @podcast.link
